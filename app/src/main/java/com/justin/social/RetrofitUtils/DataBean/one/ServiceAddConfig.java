...
public class ServiceAddConfig extends BaseModel {
    private String id;
    private String serviceName;
    private String serviceCharge;
    private String serviceInfo;
    private String status;
    private List<ServiceAddConfig>data;
    ...
    public ServiceAddConfig(Context context) {
        super(context);
    }
    ...
    public List<ServiceAddConfig> getData() {
        return data;
    }

    public void setData(List<ServiceAddConfig> data) {
        this.data = data;
    }
