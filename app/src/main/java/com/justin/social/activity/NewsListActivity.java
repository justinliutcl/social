...
public class NewsListActivity extends BackActivity {
    ActivityNewslistBinding bind;
    private FragmentManager mFm;
    private ArrayList<Fragment> mFragmentList = new ArrayList<Fragment>();
    private String[] mFragmentTagList = {"newsOne", "newsTwo", "newsThree"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bind = DataBindingUtil.setContentView(this,R.layout.activity_newslist);
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        line3 = (TextView) findViewById(R.id.new_line);
    }

    private void initData() {
        Bundle bundle = new Bundle();
        bundle.putString(NewsFragmentOne.TYPE, NewsListConfig.SOCIAL_HOT);

        Bundle bundle1 = new Bundle();
        bundle1.putString(NewsFragmentOne.TYPE, NewsListConfig.SOCIAL_NEWS);

        Bundle bundle2 = new Bundle();
        bundle2.putString(NewsFragmentOne.TYPE, NewsListConfig.POLICE_NEWS);
        //fragment保存参数，传入一个Bundle对象

        NewsFragmentOne oneFragment = new NewsFragmentOne();
        NewsFragmentOne twoFragment = new NewsFragmentOne();
        NewsFragmentOne threeFragment = new NewsFragmentOne();
