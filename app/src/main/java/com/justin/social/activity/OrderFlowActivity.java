...
import com.justin.social.databinding.ActivityOrderflowBinding;
import com.justin.social.fragment.NewsFragmentOne;
import com.justin.social.fragment.OrderFlowFragment;

import java.util.ArrayList;

public class OrderFlowActivity extends BackActivity {
    ActivityOrderflowBinding bind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bind = DataBindingUtil.setContentView(this,R.layout.activity_orderflow);
        initData();
        initView();
    }
    ...
    private void initData() {
        ...
        OrderFlowFragment oneFragment = new OrderFlowFragment();
        OrderFlowFragment twoFragment = new OrderFlowFragment();
